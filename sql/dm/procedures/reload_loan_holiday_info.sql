...
$$
    BEGIN
        RAISE NOTICE 'Reload dm.loan_holiday_info started';

        TRUNCATE TABLE dm.loan_holiday_info;

        RAISE NOTICE 'dm.loan_holiday_info truncated';
        ...
        RAISE NOTICE 'Reload dm.loan_holiday_info finished';

    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error while reloading dm.loan_holiday_info: %', SQLERRM;
            RAISE;
    END;
$$;